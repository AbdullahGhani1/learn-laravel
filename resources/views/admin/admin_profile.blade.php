                            ...
                            <div class="align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="overflow-hidden ms-4">
                                        ...
                                        <span class="fs-15"><i
                                                class="mdi mdi-message me-2 align-middle"></i>Speaks: <span>English <span
                                                    class="badge bg-primary-subtle text-primary px-2 py-1 fs-13 fw-normal">native</span> , Bitish, Turkish </span></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-content text-muted bg-white">
                                <div class="tab-pane active show pt-4" id="profile_about" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-4">
                                            <div class="">
                                                <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">About
                                                    me</h5>
                                                <p>Geetings, fellow software enthusiasts! I'm thrilled to see your
                                                    intereset in exploring my profile. I'm Christian Mayo,
                                                    a 24-year-old software engineer from the United Kingdom. My
                                                    educational path led me to earn a Bachelor's Degeer in Computer
                                                    Science,
                                                    ...
                                                    to tackle exciting projects and contribute to cutting-edge
                                        ...
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-4">
                                            <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">Contact
                                                Details</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-0">
                                            <div class="">
                                                <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">
                                                    Projects</h5>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <h4 class="m-0 fw-semibold text-dark fs-16">Website
                                                                Developing</h4>
                                                ...
                                                <div class="col-6">
                                                    <div class="card border mb-0">
                                                        <div class="card-body ">
                                                            <h4 class="m-0 fw-semibold text-dark fs-16">Digital
                                                                Marketing</h4>
                                                            <div class="row mt-2 d-flex align-items-center">
                                                                <div class="col">
                                                ...
                                                <div class="col-6">
                                                    <div class="card border mb-0">
                                                        <div class="card-body">
                                                            <h4 class="m-0 fw-semibold text-dark fs-16">Mobile
                                                                Developing</h4>
                                                            <div class="row mt-2 d-flex align-items-center">
                                                                <div class="col">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-0">
                                            ...
                                            <div class="row align-items-center g-0 mt-3">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> HTML
                                                    </p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                            ...
                                            <div class="row align-items-center g-0 mt-3">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> CSS
                                                    </p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                            ...
                                            <div class="row align-items-center g-0 mt-3">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> Php
                                                    </p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <ol class="profile-section list-unstyled mb-0 px-4">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <div>
                                                                ...
                                                                <div class="list-inline list-inline-dots mb-1 fs-14">
                                                                    ...
                                                                    <div
                                                                        class="list-inline-item list-inline-item-second">
                                                                        Full-time
                                                                    </div>
                                                                </div>
                                                                <div class="list-inline list-inline-dots mb-2 fs-14">
                                                                    <div class="list-inline-item">Jan 2020 - Present
                                                                    </div>
                                                                    <div
                                                                        class="list-inline-item list-inline-item-second">
                                                                        2 years
                                                                ...
                                                                <p class="mb-0">Responsible for the product management,
                                                                    product design, research and product partnerships
                                                                    teams at Notion.</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <div>
                                                                <h5 class="font-size-16 mb-1">VP, Product
                                                                    Management</h5>
                                                                <div class="list-inline list-inline-dots mb-1 fs-14">
                                                                ...
                                                                <div class="list-inline list-inline-dots mb-2 fs-14">
                                                                    <div class="list-inline-item">Feb 2016 - May 2020
                                                                    </div>
                                                                    <div
                                                                        class="list-inline-item list-inline-item-second">
                                                                        2 years
                                                    ...
                                                    <li class="profile-item pb-0">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Director, Product
                                                                Management</h5>
                                                            <div class="list-inline list-inline-dots mb-1 fs-14">
                                                ...
                                                <ol class="profile-section list-unstyled mb-0 px-4">
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            ...
                                                            <div class="list-inline list-inline-dots mb-2 fs-14">
                                                                <div class="list-inline-item">June 2010 - July 2013
                                                                </div>
                                                            ...
                                                            <p class="mb-0">Underlook 6 dynamic projects withing just 8
                                                                months, showcasing my versatility and
                                                                proactiveapprocach. Notable accomplishments include
                                                                Designed.</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Mobile Developer & Algo
                                                                Expert</h5>
                                                            <div class="list-inline list-inline-dots mb-1 fs-14">
                                                            ...
                                                            <div class="list-inline list-inline-dots mb-2 fs-14">
                                                                <div class="list-inline-item">June 2009 - July 2010
                                                                </div>
                                                    ...
                                                    <li class="profile-item pb-0">
                                                        ...
                                                        <div class="exper-item-list">
                                                            ...
                                                            <div class="list-inline list-inline-dots mb-2 fs-14">
                                                                <div class="list-inline-item">June 2008 - July 2009
                                                                </div>
                                                                <div class="list-inline-item list-inline-item-second">1
                                                                    years
                                                                </div>
                                ...
                                <div class="tab-pane pt-4" id="profile_education" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-6">
                                            <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">My
                                                Education</h5>
                                        </div>
                                            ...
                                            <div class="col-4">
                                                <ol class="profile-section list-unstyled mb-0 px-4">
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="fs-18 text-dark">Middles Earth Technic
                                                                University</h5>
                                                            <p class="mb-2 fw-semibold text-dark">Master Degree In
                                            ...
                                            <div class="col-4">
                                                <ol class="profile-section list-unstyled mb-0 px-4">
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="fs-16 text-dark">Bogazicied Technic
                                                                University</h5>
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                                    ...
                                                                    <g mask="url(#circleFlagsUnitedNations0)">
                                                                        ...
                                                                        <circle cx="256" cy="256" r="22"
                                                                                fill="#338af3"/>
                                                                        <ellipse cx="256" cy="412" fill="#eee" rx="44"
                                                                                 ry="40"/>
